...
impl PixServer {
    ...
    #[tool(
        ...
        description = "Extract a rendered frame (backbuffer/RTV) from a capture as a PNG and \
                       return it inline as an image so a vision model can inspect the render.",
